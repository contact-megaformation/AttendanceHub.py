...
# ---------- Question Banks ----------
# Listening: list of dicts per level
L_BANK = {
    "A1": [
...
# Reading Comprehension: passage + questions per level
R_PASSAGES = {
    "A1": {
...
# Use of English (grammar & vocab): list of tuples per level
U_BANK = {
    "A1": [
...
# Writing prompts (topic keywords used for heuristic scoring)
W_PROMPTS = {
